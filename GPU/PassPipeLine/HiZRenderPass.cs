...
namespace GPUDriven
{
    [Obsolete("이 클래스는 더 이상 사용되지 않습니다. GPUDriven 네임스페이스의 GeometryRenderPass 클래스를 사용하세요.")]
    /// <summary>
    /// GPU 드리븐 렌더링 파이프라인
    ...
    public unsafe class HiZRenderPass
    {
         ...
         * 3  - AABB Buffer
         * 4  - Batch ID Buffer
         * 5  - Visible Indices LOD0
         * 6  - Visible Counts LOD0
         * 7  - Visible Indices LOD1
         * 8  - Visible Counts LOD1
         * 9  - Visible Indices LOD2
         * 10 - Visible Counts LOD2
         * 11 - Visible Indices LOD3
         * 12 - Visible Counts LOD3
         * 13 - Indirect Command Buffer
         * 14 - (예비)
         * 15 - (예비)
         */
        ...
        private void CreateSSBOs()
        {
            ...
            CreateSSBOBuffer(ref _batchIDSSBO, 12, MAX_INSTANCES * 4, BufferUsage.StaticDraw);     // Batch ID (uint)
