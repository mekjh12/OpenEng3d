...
namespace FormTools
{
    public partial class FormShadow : Form, GlControlerable
    {
        ...
        */
        ...
        public void RenderFrame(double deltaTime, Vertex4f backcolor, Camera camera)
        {
            ...
            // 물체 세도우맵 갱신
            _gpuDriven.RenderShadowLod0(camera, _sunLight.Direction);
        ...
        private void BlitToScreen(int deltaTime, Camera camera)
        {
            ...
            else if (_isVisibleRenderDepthBuffer)
            {
                ...
                _renderDepthShader.Bind();
                {
                    ...
                    _renderDepthShader.LoadDepthTexture(
                        ...
                        _gpuDriven.InstanceShadowMapTextureID//_terrainRenderer.ShadowMapTextureID //_glControl3.DepthTextureId  // 또는 적절한 프로퍼티명
                    );
            ...
            else
            {
                ...
                else
                {
                    ...
                    _deferredRenderer.SetInstanceShadowMap(_gpuDriven.InstanceShadowMap);
