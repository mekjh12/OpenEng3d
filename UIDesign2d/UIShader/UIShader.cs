...
namespace ZetaEngine
{
    ...
    {
        const string VERTEX_FILE = @"\Shader\UIShader\ui2d.vert";
        const string FRAGMENT_FILE = @"\Shader\UIShader\ui2d.frag";
        ...
        public uint VAO
        {
            get
            {
                return _rawModel.VAO;
            }
        }

        public uint VAO_LINE
        {
            get
            {
                return _rawModelLine.VAO;
            }
        }
        ...
        public UIShader() :
            base(EngineLoop.PROJECT_PATH + VERTEX_FILE, EngineLoop.PROJECT_PATH + FRAGMENT_FILE,"")
        {
