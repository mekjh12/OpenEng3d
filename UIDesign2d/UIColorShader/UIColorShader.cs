...
namespace ZetaEngine
{
    ...
    /// 텍스처에 직사각형 모양을 렌더링한다.
    /// </summary>
    public class UIColorShader : ShaderProgram
    {
        const string VERTEX_FILE = @"\Shader\UIColorShader\uiColor2d.vert";
        const string FRAGMENT_FILE = @"\Shader\UIColorShader\uiColor2d.frag";
