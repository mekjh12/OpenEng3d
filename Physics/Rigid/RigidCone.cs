...
namespace Physics
{
    public class RigidCone : RigidBody
    {
        float _radius;
        float _height;
        ...
        public RigidCone(Matter matter, float radius, float height) : base(matter)
        {
            _radius = radius;
            _height = height;

            // 부피를 계산한다.
            _volume = (float)(0.33333f * MathFast.PI * _radius * _radius * _height);
