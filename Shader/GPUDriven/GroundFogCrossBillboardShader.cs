...
namespace Shader
{
    public class GroundFogCrossBillboardShader : ShaderProgramBase
    {
        const string VERTEX_FILE = @"\Shader\GPUDriven\glsl\groundfog_crossbillboard_instance.vert";
        const string GEOMETRY_FILE = @"\Shader\GPUDriven\glsl\groundfog_crossbillboard_instance.geom";
        const string FRAGMENT_FILE = @"\Shader\GPUDriven\glsl\groundfog_crossbillboard_instance.frag";
        ...
        public GroundFogCrossBillboardShader(string projectPath) : base()
        {
