...
namespace Shader
{
    public class AxisShader : ShaderProgram<AxisShader.UNIFORM_NAME>
    {
        ...
        public void RenderAxes(Matrix4x4f model, Matrix4x4f boneTransform, Matrix4x4f viewProjection,
            float axisLength = 10.0f, float lineWidth = 1.0f)
        {
            // 렌더링 상태 설정
            ...
            Matrix4x4f finalTransform = viewProjection * model * boneTransform * scaleMatrix;
        ...
        /// 여러 객체의 좌표축을 배치 렌더링
        /// </summary>
        public void RenderAxes(Matrix4x4f model, Matrix4x4f[] boneTransforms, Matrix4x4f viewProjection, 
            float axisLength = 10.0f, float lineWidth = 1.0f)
        {
